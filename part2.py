...
print(val)
host = "10.254.254.64"    #your rpi ip address here
port = 6668
...
if val==1:
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s4:
        ...
        message4=  b"{ \"Tweet Type\" : \"Service call\", \"Thing ID\" : \"MySmartThing01\", \"Space ID\" : \"MySmartSpace\", \"Service Name\" : \"Temp_Celsius_C\", \"Service Inputs\" : \"()\" }"
        s4.sendall(message4)
